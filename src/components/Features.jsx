  ...
  return (
    <div className="relative size-full">
      <video
        ...
        muted
        autoPlay
        className="absolute left-0 top-0 size-full object-cover object-center rounded-md"
      />
      ...
      <div className="container mx-auto px-3 md:px-10">
        <div className="px-5 py-32">
          ...
          <p className="max-w-md font-circular-web text-lg text-blue-50 opacity-50">
            Immerse yourself in an IP-rich product universe where players, agentic AI and
            blockchain lead the new economic paradigm.{" "}
          </p>
        </div>
        ...
        <div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-1">
          <BentoTilt className="bento-tilt row-span-1 md:col-span-1 md:row-span-2 ">
            <BentoCard
